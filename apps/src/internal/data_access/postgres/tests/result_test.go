...
func (suite *ResultDATestSuite) SetupSuite() {
	...
	/*err = db.AutoMigrate(&domain.Competition{}, &domain.Sportsman{})
	if err != nil {
		log.Fatal(err)
		return
	}

	err = db.AutoMigrate(&domain.Result{})
	if err != nil {
		log.Fatal(err)
		return
	}*/
...
func (suite *ResultDATestSuite) TearDownSuite() {
	/*err := suite.db.Migrator().DropTable(&domain.Result{})
	if err != nil {
		log.Fatal(err)
		return
	}*/
...
func (suite *ResultDATestSuite) TestCreate() {
	...
	var fetchedResult domain.Result
...
func (suite *ResultDATestSuite) TestUpdate() {
	...
	var updatedResult domain.Result
