...
VALUES ('f8f26e6d-3e36-416a-9ff0-253876fcbbbb', 'sec@mail.ru', '123', 'secretary');

INSERT INTO users (id, email, password, role)
VALUES ('f8f26e6d-3e36-416a-9ff0-253876fcbccc','comp@mail.ru', '123', 'competition organizer');

INSERT INTO users (id, email, password, role)
VALUES ('f8f26e6d-3e36-416a-9ff0-253876fcbddd', 'tcamp@mail.ru', '123', 'training camp organizer');

INSERT INTO competitions (id, name, city, address, beg_date, end_date, age, min_sports_category, antidoping, org_id)
VALUES ('a8f26e6d-3e36-416a-9ff0-253876fc1115', 'Кубок1', 'Москва', 'Улица 1', '2023-12-10', '2023-12-12', 'мужчины, женщины', 'I', false, 'f8f26e6d-3e36-416a-9ff0-253876fcbccc');

INSERT INTO competitions (id, name, city, address, beg_date, end_date, age, min_sports_category, antidoping, org_id)
VALUES ('b8f26e6d-3e36-416a-9ff0-253876fc1115', 'Кубок2', 'Москва', 'Улица 1', '2023-12-10', '2023-12-12', 'мужчины, женщины', 'I', false, 'f8f26e6d-3e36-416a-9ff0-253876fcbccc');

INSERT INTO t_camps (id, city, address, beg_date, end_date, org_id)
VALUES ('aaa26e6d-3e36-416a-9ff0-253876fc1115', 'Москва', 'Улица 1', '2024-12-10', '2024-12-12', 'f8f26e6d-3e36-416a-9ff0-253876fcbddd');
...
COPY sportsmen
FROM '/app_spa/sql/data/sportsmenData.csv' DELIMITER ',';

COPY comp_accesses
FROM '/app_spa/sql/data/accessData.csv' DELIMITER ',';

COPY antidopings
FROM '/app_spa/sql/data/antidopingData.csv' DELIMITER ',';

COPY coaches
FROM '/app_spa/sql/data/coachesData.csv' DELIMITER ',';

-- COPY competitions
-- FROM '/app_spa/sql/data/competitionsData.csv' DELIMITER ',';

-- COPY results
-- FROM '/app_spa/sql/data/resultsData.csv' DELIMITER ',';

COPY sportsmen_coaches
FROM '/app_spa/sql/data/sportsmenCoachesData.csv' DELIMITER ',';

-- COPY t_camps
-- FROM '/app_spa/sql/data/t_campsData.csv' DELIMITER ',';

CREATE USER readonly_user WITH PASSWORD 'readonly_password';
GRANT CONNECT ON DATABASE test_WL TO readonly_user;
